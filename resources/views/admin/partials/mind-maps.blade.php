<div class="py-8">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
        ...
        <div class="flex items-center justify-between">
            ...
            <a
                href="{{ route('admin.mind-maps.create', ['locale' => app()->getLocale()]) }}"
        ...
        <div class="flex flex-wrap items-center gap-2">
            ...
            @foreach($groups as $key)
                <a
                    ...
                    hx-get="{{ route('admin.mind-maps.index', ['locale' => app()->getLocale(), 'group' => $key]) }}"
                    hx-target="#admin-content" hx-swap="innerHTML" hx-push-url="true"
        ...
        <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
                            ...
                            <tr class="hover:bg-gray-50/50 dark:hover:bg-gray-700/20 transition-colors">
                                ...
                                <td class="px-3 py-3 text-right">
                                    <div class="flex items-center justify-end gap-2">
                                        <a href="{{ route('admin.mind-maps.edit', ['locale' => app()->getLocale(), 'mindMap' => $map]) }}" class="rounded-lg px-2.5 py-1 text-xs font-medium text-blue-700 hover:bg-blue-50 dark:text-blue-400 dark:hover:bg-blue-950/30 transition-colors border border-blue-200 dark:border-blue-800">
                                            Edit
                                        </a>
            ...
            @else
                <div class="py-16 text-center">
                    ...
                    <a href="{{ route('admin.mind-maps.create', ['locale' => app()->getLocale()]) }}" class="mt-4 inline-block text-blue-600 text-sm font-medium hover:underline">Create your first one →</a>
                </div>
            @endif
        </div>
