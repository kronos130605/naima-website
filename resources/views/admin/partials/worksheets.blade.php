<div class="py-8">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
        ...
        <div class="flex items-center justify-between">
            <h2 class="text-lg font-semibold text-slate-800 dark:text-slate-100">Worksheets</h2>
            <button
        ...
        <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
                            ...
                            <tr class="hover:bg-gray-50/50 dark:hover:bg-gray-700/20 transition-colors">
                                ...
                                <td class="px-3 py-3 text-right">
                                    <div class="flex items-center justify-end gap-2">
                                        ...
                                        <form method="POST" action="{{ route('admin.worksheets.destroy', ['locale' => app()->getLocale(), 'worksheet' => $worksheet]) }}" onsubmit="return confirm('Delete this worksheet?')">
                                            @csrf @method('DELETE')
            ...
            @else
                <div class="py-16 text-center">
                    ...
                    <p class="text-gray-500 dark:text-gray-400 text-sm">No worksheets found.</p>
                    <button
                        hx-get="{{ route('admin.worksheets.create', ['locale' => app()->getLocale()]) }}"
                        hx-target="#admin-modal-content"
                        hx-swap="innerHTML"
