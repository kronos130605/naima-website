<nav x-data="{ open: false }" class="bg-white/80 backdrop-blur-md border-b border-blue-100 dark:bg-slate-950/80 dark:border-slate-800">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="-me-2 flex items-center sm:hidden">
                <button @click="open = ! open" class="inline-flex items-center justify-center p-2 rounded-md text-slate-500 hover:text-slate-700 hover:bg-blue-50 focus:outline-none focus:bg-blue-50 focus:text-slate-700 transition duration-150 ease-in-out dark:text-slate-300 dark:hover:text-white dark:hover:bg-slate-800 dark:focus:bg-slate-800 dark:focus:text-white">
