<x-site-layout :title="__('site.page_title.contact')" :brand="$brand" :cta="$cta" :locale="$locale" :locales="$locales">
    ...
    <section class="bg-gradient-to-br from-rose-600 via-pink-600 to-purple-700 py-16 px-4">
        <div class="mx-auto max-w-4xl text-center">
            ...
            <h1 class="text-3xl sm:text-4xl font-extrabold text-white leading-tight">
                {{ __('site.contact.hero_title') }}
            </h1>
            <p class="mt-4 text-lg text-rose-100 max-w-xl mx-auto">
                {{ __('site.contact.hero_body') }}
            </p>
        </div>
    </section>
    ...
    <section class="bg-gradient-to-br from-rose-50 to-pink-50 dark:from-slate-900 dark:to-slate-800 py-16 px-4">
        <div class="mx-auto max-w-2xl text-center">
            <h2 class="text-2xl font-extrabold text-slate-900 dark:text-white">{{ __('site.contact.cta_title') }}</h2>
            <p class="mt-3 text-slate-600 dark:text-slate-300">{{ __('site.contact.cta_body') }}</p>
            <a
