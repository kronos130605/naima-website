<x-site-layout title="Our Method — FrenchBoost" :brand="$brand" :cta="$cta" :locale="$locale" :locales="$locales">
    ...
    <section class="bg-gradient-to-br from-violet-600 via-purple-600 to-indigo-700 py-16 px-4">
        <div class="mx-auto max-w-4xl text-center">
            ...
            <h1 class="text-3xl sm:text-4xl font-extrabold text-white leading-tight">
                The FrenchBoost Learning Strategy
            </h1>
            <p class="mt-4 text-lg text-violet-100 max-w-xl mx-auto">
                Learn, Apply, Grow — a proven method designed to help learners boost their French skills and unlock their full potential.
            </p>
        </div>
    </section>
    ...
    <section class="bg-gradient-to-br from-violet-50 to-purple-50 dark:from-slate-900 dark:to-slate-800 py-16 px-4">
        <div class="mx-auto max-w-2xl text-center">
            <h2 class="text-2xl font-extrabold text-slate-900 dark:text-white">Experience the method first-hand</h2>
            <p class="mt-3 text-slate-600 dark:text-slate-300">Book a free assessment and see how Learn, Apply, Grow works in a real session.</p>
            <a
