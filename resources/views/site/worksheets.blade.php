<x-site-layout :title="__('site.page_title.worksheets')" :brand="$brand" :cta="$cta" :locale="$locale" :locales="$locales">
        ...
        <div class="mx-auto max-w-6xl">
            ...
            @if($grouped->isEmpty())
                ...
                <div class="text-center py-20">
                    ...
                    <h2 class="text-xl font-bold text-slate-800 dark:text-slate-100 mb-2">{{ __('site.worksheets.empty_title') }}</h2>
    ...
    <section class="bg-gradient-to-br from-teal-50 to-emerald-50 dark:from-slate-900 dark:to-slate-800 py-16 px-4">
        <div class="mx-auto max-w-2xl text-center">
            <h2 class="text-2xl font-extrabold text-slate-900 dark:text-white">{{ __('site.worksheets.cta_title') }}</h2>
            <p class="mt-3 text-slate-600 dark:text-slate-300">{{ __('site.worksheets.cta_body') }}</p>
            <a
                href="{{ route('site.booking', ['locale' => $locale]) }}"
